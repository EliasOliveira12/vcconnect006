...
public class UsuarioController {
    ...
    @Operation(summary = "Metodo para criar um usuario",method = "POST")
    @ApiResponses(value ={
            @ApiResponse(responseCode = "201",description = "Cadastro de usuario feito com sucesso"),
            @ApiResponse(responseCode = "400",description = "Paramentros invalidos")
